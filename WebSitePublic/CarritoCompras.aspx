<%--<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CarritoCompras.aspx.cs" Inherits="CarritoCompras" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>--%>
...
<head>
    ...
    <script type="text/javascript">
        function DeleteProduct(id) {
            __doPostBack('btnDeleteProduct', id)
        }
    </script>
...
<body>
    <form id="form1" runat="server">
        ...
        <!-- Loader -->
        <!--Page Wrapper Start-->
        <div id="wrapper" class="categories shopping-cart">
            <!--container Start-->
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div runat="server" id="divCartItems" class="cart-item">
                                </div>
                                <!-- Cart Items Starts Here -->
                            </div>
                            <div class="row">
                                <div class="col-xs-12 col-sm-8 col-md-8">
                                    <span class="shopping-btn"><a href="#">limpiar carro de compras</a></span>
                                </div>
                                <%--<div class="col-xs-12 col-sm-4 col-md-4">
                                    <span class="shopping-btn"><a href="#">actualizar</a></span>
                                </div>--%>
                                <div class="col-xs-12 col-sm-4">
                                    <div class="cart-checkout">
                                        <div class="total">
                                            <span class="sub-total">sub total <strong>
                                                <asp:Literal runat="server" ID="ltlSubtotal"></asp:Literal></strong></span>
                                            <span class="grand-total">total <strong>
                                                <asp:Literal runat="server" ID="ltlTotal"></asp:Literal></strong></span>
                                        </div>
                                        <asp:Button ID="btnConfirmShopping" runat="server" OnClick="btnConfirmShopping_Click" CssClass="btn cart-proceed" Text="Confirmar Compra" />
                                    </div>
                                </div>
                            </div>
                        </div>
